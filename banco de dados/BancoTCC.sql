...
-- Copiando dados para a tabela siep.entrevistas: ~2 rows (aproximadamente)
...
INSERT INTO `perfil_usuario` (`id_perfil`, `id_usuario`, `foto_perfil`, `sobre_voce`, `escolaridade`, `instituicao`, `curso`, `habilidades`, `arquivo_pdf`) VALUES
	...
	(3, 3, '1778585698503-90c097159b9bf2eac99ed4f5a259ca52.jpg', 'Adicione uma descrição sobre você', '', '', 'ADM', '["comunicação"]', NULL);
...
-- Copiando dados para a tabela siep.vagas_candidatar: ~5 rows (aproximadamente)
